...
EXCEL = r"pages.xlsx"
OUT = Path(r"E:\conda-envs\docling_output")
...
with open(LOG, "w", encoding="utf-8") as log:
    ...
    for pdf_name, page_nums in list(pages.items())[:10]:
        ...
        for page_num in page_nums:
            ...
            # Markdown
            md_path = page_out / "document.md"

            with open(md_path, "w", encoding="utf-8") as f:
                f.write(document.export_to_markdown())

            # JSON
            json_path = page_out / "document.json"
            ...
            if tables:
                ...
                excel_path = page_out / "tables.xlsx"
                ...
                with pd.ExcelWriter(excel_path, engine="openpyxl") as writer:
                    ...
                    for i, table in enumerate(tables, 1):
                        ...
                        table_df.to_excel(writer, sheet_name=f"Table_{i}", index=False)
